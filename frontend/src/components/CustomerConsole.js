...
function CustomerConsole() {
  ...
  const handleRun = async () => {
    ...
    try {
      const res = await fetch('http://localhost:3000/simulate/customer/appium', {
        method:  'POST',
  ...
  return (
    <div className="cc-root">
      <div className="cc-bg-orb cc-orb-1" />
      <div className="cc-bg-orb cc-orb-2" />

      {/* Header */}
      <header className="cc-header">
        <div className="cc-header-left">
          <div className="cc-eyebrow"><span className="cc-eyebrow-dot" />App Simulation</div>
          <h2 className="cc-title">Customer <em>Payment Console</em></h2>
